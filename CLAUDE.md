...
- **Claude Code `/login` OAuth paste:** a 2.1.105 regression broke paste in the code prompt ([anthropics/claude-code#47669](https://github.com/anthropics/claude-code/issues/47669), [#47670](https://github.com/anthropics/claude-code/issues/47670)). Fixed upstream in [commit 5c18c78](https://github.com/anthropics/claude-code/commit/5c18c787f262242a4266a12d2d1123808394fbce); current installs (2.1.108+) work. If auth still fails, set `ANTHROPIC_API_KEY` (console.anthropic.com) or copy `~/.claude.json` + `~/.claude/` from another machine. See [Claude Code auth docs](https://code.claude.com/docs/en/authentication).
