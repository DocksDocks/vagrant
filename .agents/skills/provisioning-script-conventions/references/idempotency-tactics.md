...
The marker string MUST be unique per script (use the script's filename in a comment). Scripts using this pattern: `scripts/80-git-ssh-lazygit.sh:16-22`, `scripts/85-secrets-env.sh:50`, `scripts/60-apps-tilix-mousepad.sh:74`, `scripts/70-nodejs-claude.sh:45`.
